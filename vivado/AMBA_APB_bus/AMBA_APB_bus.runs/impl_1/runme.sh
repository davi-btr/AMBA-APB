...
HD_PWD='C:/Users/betta/Documents/WORKSPACE/PSM/DIGITALE/Project_AMBA_APB/vivado/AMBA_APB_bus/AMBA_APB_bus.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log APB_bus_wrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source APB_bus_wrap.tcl -notrace
